...
public class NewReleaseFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        pagiNationButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                counter++;
                fetchMovies(ResourceProvider.NEW_RELEASE_URL + counter);
            }
        });


        this.fetchMovies(ResourceProvider.NEW_RELEASE_URL + counter);
    ...
    private void setupRecyclerView(MoviePage moviePage) {
        ...
        recyclerView.setAdapter(new RecyclerAdapter(getActivity(), moviePage.getresults().subList(0, 10),"newrelease"));
